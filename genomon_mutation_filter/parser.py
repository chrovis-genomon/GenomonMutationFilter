...
def create_parser():
    ...
    def _create_realignment_parser(subparsers):
        ...
        realign_parser.add_argument( '-b', '--bwa_path', type = str, default = None, required = True)
        realign_parser.add_argument("--bwa_option", help = "Option used in bwa", type = str, default = None)
