...
def run_realignment_filter(arg):
    ...
    realignf = rf.Realignment_filter(arg.ref_genome, arg.tumor_min_mismatch, arg.normal_max_mismatch, arg.window_size, arg.score_difference, arg.bwa_path, arg.bwa_option, arg.header_flag, arg.max_depth, arg.exclude_sam_flags, arg.thread_num)
    if is_anno == True:
